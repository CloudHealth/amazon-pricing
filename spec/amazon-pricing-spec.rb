  ...
  describe 'new' do
    it 'RdsPriceList.new should return the valid response' do 
      ...
      result.regions.each do |region|
        ...
        region.instance_types.first.category_types.first.ondemand_price_per_hour.should_not be_nil
      	region.instance_types.first.category_types.first.light_price_per_hour_1_year.should_not be_nil
      	region.instance_types.first.category_types.first.medium_price_per_hour_1_year.should_not be_nil
      	region.instance_types.first.category_types.first.heavy_price_per_hour_1_year.should_not be_nil
      end
    end
  end
