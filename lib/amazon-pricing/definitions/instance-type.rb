...
module AwsPricing
  ...
  class InstanceType
    ...
    @@Name_Lookup = { # basic name and description lookup
      ...
      'u-6tb1.metal' => 'Memory Optimized High I/O 6tb Metal', 'u-9tb1.metal' => 'Memory Optimized High I/O 9tb Metal', 'u-12tb1.metal' => 'Memory Optimized High I/O 12tb Metal',
    ...
    @@Disk_Lookup = { # size of disk supported (local disk size) TOTAL size in gb
      ...
      'u-6tb1.metal' => 0, 'u-9tb1.metal' => 0, 'u-12tb1.metal' => 0, #ebs-only
    ...
    @@Platform_Lookup = { #bit width of cpu
      ...
      'u-6tb1.metal' => 64, 'u-9tb1.metal' => 64, 'u-12tb1.metal' => 64,
    ...
    @@Disk_Type_Lookup = { #type of local storage for the disk
      ...
      'u-6tb1.metal' => :ebs, 'u-9tb1.metal' => :ebs, 'u-12tb1.metal' => :ebs,
