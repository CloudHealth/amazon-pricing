...
module AwsPricing
  ...
  class InstanceType
    ...
    @@Name_Lookup = { # basic name and description lookup
      ...
      't3.nano' => 'Burstable Perforamcne Instance Nano', 't3.micro' => 'Burstable Perforamcne Instance Micro', 't3.small' => 'Burstable Perforamcne Instance Small', 't3.medium' => 'Burstable Perforamcne Instance Medium', 't3.large' => 'Burstable Perforamcne Instance Large',
        't3.xlarge' => 'Burstable Perforamcne Instance Extra Large','t3.2xlarge' => 'Burstable Perforamcne Instance Double Extra Large',
