...
module AwsPricing
  ...
  class InstanceType
    ...
    @@Disk_Lookup = { # size of disk supported (local disk size) TOTAL size in gb
      ...
      'g3.4xlarge' => 0, 'g3.8xlarge' => 0, 'g3.16xlarge' => 0, 'g3s.xlarge' => 0, # g3 are ebs-only
    ...
    @@Platform_Lookup = { #bit width of cpu
      ...
      'g3.4xlarge' => 64, 'g3.8xlarge' => 64, 'g3.16xlarge' => 64, 'g3s.xlarge' => 64,
    ...
    @@Disk_Type_Lookup = { #type of local storage for the disk
      ...
      'g3.4xlarge' => :ebs, 'g3.8xlarge' => :ebs, 'g3.16xlarge' => :ebs, 'g3s.xlarge' => :ebs,
      'unknown' => :ephemeral,
