...
module AwsPricing
  ...
  class InstanceType
    ...
    PER_SEC_CAPACITIES = {
      ...
      'i2.xlarge' => [480, 45439],
      'i3.16xlarge' => [1351600000, 3300000],	# NVMe SSD: 3.3M iops
      'i3.8xlarge'  => [ 675800000, 1650000],
      'i3.4xlarge'  => [ 337900000,  825000],
      'i3.2xlarge'  => [ 168950000,  412500],
      'i3.xlarge'   => [  84475000,  206250],
      'i3.large'    => [  42237500,  103125],
      'm1.large' => [252, 29830],
      'm1.medium' => [134, 9855],
      'm1.small' => [112, 11776],
      'm1.xlarge' => [436, 34630],
