module AwsPricing
  class Ec2DedicatedHostInstancePriceList < PriceList
    ...
    @@CAPACITY_HASH = { # number of instances a host can run, by definition largest size can only run one instance/host
      ...
      'r5' => { "large"=>36, "xlarge"=>24, "2xlarge"=>12, "4xlarge"=>6, "12xlarge"=>2, "24xlarge"=>1, "metal"=>1 },
      'r5d' => { "large"=>36, "xlarge"=>24, "2xlarge"=>12, "4xlarge"=>6, "12xlarge"=>2, "24xlarge"=>1, "metal"=>1 },
      'r5a' => { "large"=>36, "xlarge"=>24, "2xlarge"=>12, "4xlarge"=>6, "12xlarge"=>2, "24xlarge"=>1 },
      'r5ad' => { "large"=> 36, "xlarge"=> 24, "2xlarge"=> 12, "4xlarge"=> 6, "12xlarge"=> 2, "24xlarge" => 1},
      ...
      'm5ad' => { "large"=> 36, "xlarge"=> 24, "2xlarge"=> 12, "4xlarge"=> 6, "12xlarge"=> 2, "24xlarge" => 1},
